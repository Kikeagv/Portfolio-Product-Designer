...
const Folder: React.FC<FolderProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="rounded-tl-0 relative h-20 w-[100px] rounded-tr-[10px] rounded-br-[10px] rounded-bl-[10px]"
          style={{ backgroundColor: folderBackColor }}
        >
          <span
            className="rounded-bl-0 rounded-br-0 absolute bottom-[98%] left-0 z-0 h-2.5 w-[30px] rounded-tl-[5px] rounded-tr-[5px]"
            style={{ backgroundColor: folderBackColor }}
          ></span>
          {papers.map((item, i) => {
            let sizeClasses = "";
